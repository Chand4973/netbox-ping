...
class DeviceViewExtension(PluginTemplateExtension):
    ...
    def buttons(self):
        ...
        return self.render("netbox_ping/compare_interfaces_button.html", extra_context={
            "device": obj
        })
    ...
    def right_page(self):
        ...
        return self.render("netbox_ping/number_of_interfaces_panel.html", extra_context={
